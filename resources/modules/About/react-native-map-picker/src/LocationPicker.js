...
export default class LocationPicker extends Component {
  ...
  componentDidMount() {
    ...
    if (initialCoordinate) this.setPosition(initialCoordinate);
  ...
  onMapPress = (e) => {
    ...
    this.setPosition(coordinate);
    this.openGps(
      this.props.initialCoordinate?.latitude,
      this.props.initialCoordinate?.longitude
    );
  };
    ...
    return loading ? (
      ...
      <View style={styles.container}>
        ...
        {/* <View style={styles.selectBtnContainer}>
                        <TouchableOpacity activeOpacity={0.8} activeOpacity={0.8}style={{...styles.selectBtn, ...buttonStyle}} onPress={this.onSelect}>
